...
public class PDFDataText extends PDFDataTemplate<PDFDataText> implements Serializable
{
     ...
     */
    public PDFDataText(String i_Name ,String i_FontName)
    {
     ...
     */
    public PDFDataText(String i_Name ,Float i_FontSize)
    {
     ...
     * @param i_FontName  字体名称
     */
    public PDFDataText(String i_Name ,Float i_FontSize ,String i_FontName)
    {
     ...
     * @param i_Y         位置 y 轴
     */
    public PDFDataText(String i_Name ,Float i_X ,Float i_Y)
    {
     ...
     * @param i_FontSize  字体大小
     */
    public PDFDataText(String i_Name ,Float i_X ,Float i_Y ,Float i_FontSize)
    {
     ...
     * @param i_FontName  字体名称
     */
    public PDFDataText(String i_Name ,Float i_X ,Float i_Y ,String i_FontName)
    {
     ...
     * @param i_FontName  字体名称
     */
    public PDFDataText(String i_Name ,Float i_X ,Float i_Y ,Float i_FontSize ,String i_FontName)
    {
